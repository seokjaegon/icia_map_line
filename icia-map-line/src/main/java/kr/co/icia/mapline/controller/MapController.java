...
public class MapController {
	 ...
	 * 
	 */
	@GetMapping("/map/keyword/path") // url : /map/address/point
	 ...
	 * 
	 */
	@GetMapping("/map/keyword") // url : /map/address/point
	public String getMapKeywordPoint(@RequestParam(required = false) Double x, @RequestParam(required = false) Double y,
			@RequestParam(required = false) String keyword, Model model) throws IOException, InterruptedException {
		if (x != null && y != null && keyword != null) {
